...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ArcBold — Lend Bold. Borrow Smart." },
      { name: "description", content: "Cross-currency lending protocol on Arc Testnet. Supply USDC, borrow EURC. Or flip it." },
      { property: "og:title", content: "ArcBold — Lend Bold. Borrow Smart." },
      { property: "og:description", content: "Cross-currency lending on Arc Testnet." },
